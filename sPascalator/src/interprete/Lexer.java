  ...
  public java_cup.runtime.Symbol next_token() throws java.io.IOException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 104: break;
        case 9: 
          { if (isRealValida(yytext())) return new Symbol(Sym.pCteReal, yyline, yycolumn, new Float(yytext())); else throw new ErrorLexicoException("Constante real fuera de rango: "+yytext()+" Línea: "+yyline+" Columna: "+yycolumn);
          }
        case 105: break;
        case 42: 
